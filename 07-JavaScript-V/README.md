...
> var Emi = new Persona('Nahuel', 'Perez', 'Buenos Aires');

> Emi.saludar()
< 'Soy Nahuel de Buenos Aires'
```
...
> var nahuel = new Alumno('Nahuel', 'Perez', 'Buenos Aires', 'Web Full Stack')
...
> var Fernando = new Alumno('Fernando','Numen','Montevideo','Bootcamp')

> Fernando.saludar()
< 'Soy Fernando de Montevideo'
```
